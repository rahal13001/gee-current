...
- T3-016 rekonsiliasi read-only tersedia melalui `python/05_reconcile_inventory.py`; Graphify code-only refresh terakhir mencatat 690 node, 1.282 edge, 56 komunitas, serta diagnostics bersih. Rekonsiliasi aktual mencatat 165 job/file aktif, 1.125 timestep, 165 checksum cocok, 0 partial, dan 3 quarantine artifact sebagai note.
